...
//        Call<LoginResponse> call = AppApiHelper.getInstance().doServerLoginApiCall(new LoginRequest.ServerLoginRequest(email, password));
...
//
//                    // print error
//                    Log.e("LoginViewModel", "onResponse: " + response.errorBody().toString());
//                }
//
//            }
//
